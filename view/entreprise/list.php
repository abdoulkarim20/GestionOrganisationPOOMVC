            ...
            <tbody>
                <?php foreach ($data as $key) { ?>
                    <tr>
                        ...
                        <td class="text-center"><a href="?route&module=delete&idEntreprise=<?= $key['idEntreprise']; ?>"><i class="bi bi-eye-fill" style="color: primary; font-size:1.5rem;"></i></a></td>
                        <td class="text-center"><a href="?route&module=edit&idEntreprise=<?= $key['idEntreprise']; ?>"><i class="bi bi-pencil-square" style="color: primary; font-size:1.5rem;"></i></a></td>
                        <td class="text-center"><a href="?route&module=delete&idEntreprise=<?= $key['idEntreprise']; ?>"><i class="bi bi-trash3" style="color: #ce0033; font-size:1.5rem;"></i></a></td>
                    </tr>
                <?php } ?>
            </tbody>
        </table>
